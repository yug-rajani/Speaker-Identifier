...
from speaker.views import UploadView
from speaker.views import FilesList
from speaker.views import IndexView
from speaker.views import UploadSuccessView
from speaker.views import SelectPredFileView
from speaker.views import SelectFileDelView
from speaker.views import FileDeleteView

urlpatterns = [
    url(r'^admin/', admin.site.urls),
    url(r'^speaker/', include('speaker.urls'), name='speaker'),
